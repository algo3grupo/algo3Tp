...
public abstract class UnidadAtaqueBasico extends Unidad {
	...
	public UnidadAtaqueBasico(int dimension, JFrame ventana, Vector2D posicion, int vida, int rangoDeVision, Jugador jugador, String nombre, Costo costo, String requiere, int suministro, 
